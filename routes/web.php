...
Route::resource('/configuration/orderlist', OrderListController::class)->middleware(['auth', 'verified'])->names([
...
Route::resource('/configuration/{id}/pay', PayController::class)->middleware(['auth', 'verified'])->names([
