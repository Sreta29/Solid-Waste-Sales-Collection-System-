                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Wastage Type</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ $orderlist->id }}</td>
                                <td class="px-4 py-3">{{ $orderlist->order_date }}</td>
                                <td class="px-4 py-3">{{ $orderlist->user->name }}</td>
                                <td class="px-4 py-3">{{ $orderlist->category->name }}</td>
                                <td class="px-4 py-3">{{ $orderlist->collect_date ?? 'Not Collected Yet' }}</td>
                                <td class="px-4 py-3">{{ $orderlist->status ? 'Completed' : 'Pending'}} </td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <div class="flex items-center space-x-4">
                                        @if($user->role == 'sysadmin' && $orderlist->amount == null)
                                        ...
                                        @if (Route::has('configuration.orderlist.edit') && Auth::user()->role == 'wastage_collector' && $orderlist->amount != null && $orderlist->status == 0)
                                        <a class="bg-green-500 text-white px-3 py-1 rounded hover:bg-blue-700" href="{{ route('configuration.orderlist.edit', $orderlist->id) }}">
                                            {{ __('Complete') }}
                                        </a>
                                        @endif
                                    </div>
